...
export default function Countdown() {
  ...
  return (
    ...
    <div className="flex flex-col items-center justify-center h-screen bg-blue-400 dark:bg-white">
      {/* Timer box container */}
      <div className="bg-blue-700 shadow-lg rounded-lg p-8 w-full max-w-md">
        ...
        <div className="flex items-center mb-6">
          <Input
            ...
            className="flex-1 mr-4 rounded-md border-pink-400 dark:border-pink-600 dark:bg-pink-400 dark:text-pink-400"
          />
          <Button
        ...
        <div className="text-6xl font-bold text-pink-900 dark:text-pink-900 mb-8 text-center">
          {formatTime(timeLeft)}
        </div>
        ...
        <div className="flex justify-center gap-4">
          <Button
            onClick={handleStart}
            variant="outline"
            className="text-pink-900 dark:text-purple-500"
          >
